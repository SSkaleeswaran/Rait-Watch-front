        ...
        <div className="row d-flex flex-wrap justify-content-between py-5">
          ...
          <div className="col-md-3 col-sm-6 mb-4">
            <div>
              ...
              <ul className="list-unstyled d-flex gap-3 mt-3">
                <li><a href="https://facebook.com" className="text-secondary" aria-label="Facebook"><i className="fab fa-facebook fa-lg"></i></a></li>
                <li><a href="https://twitter.com" className="text-secondary" aria-label="Twitter"><i className="fab fa-twitter fa-lg"></i></a></li>
                <li><a href="https://youtube.com" className="text-secondary" aria-label="YouTube"><i className="fab fa-youtube fa-lg"></i></a></li>
                <li><a href="https://pinterest.com" className="text-secondary" aria-label="Pinterest"><i className="fab fa-pinterest fa-lg"></i></a></li>
                <li><a href="#https://instagram.com" className="text-secondary" aria-label="Instagram"><i className="fab fa-instagram fa-lg"></i></a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="col-md-3 col-sm-6 mb-4">
            ...
            <ul className="list-unstyled text-uppercase fs-6">
              ...
              <li><a href="/shipping" className="text-dark text-decoration-none">Shipping & Delivery</a></li>
              <li><a href="/contact" className="text-dark text-decoration-none">Contact Us</a></li>
              <li><a href="/location" className="text-dark text-decoration-none">Find Us Easy</a></li>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 d-flex gap-2 flex-wrap align-items-center">
              ...
              <img src={master} alt="MasterCard card" />
            </div>

            <div className="col-md-6 text-md-end mt-3 mt-md-0">
              <p className="mb-0">
                © 2025 Rait Watch. All rights reserved. Design by
                <a href="https://mern-todo-fron.netlify.app/" className="text-dark text-decoration-none ms-1">
                  simple
                </a>
              </p>
            </div>
